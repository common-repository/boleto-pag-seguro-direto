...
*/
include_once('BoletoPagSeguroDireto_InstallIndicator.php');
class BoletoPagSeguroDireto_LifeCycle extends BoletoPagSeguroDireto_InstallIndicator {
    public function install() {
        // Initialize Plugin Options
        $this->initOptions();
        // Initialize DB Tables used by the plugin
        $this->installDatabaseTablesAnPagesBoletoPagSeguroDireto();
    ...
    public function uninstall() {
        $this->otherUninstall();
        $this->unInstallDatabaseTablesAnPagesBoletoPagSeguroDireto();
