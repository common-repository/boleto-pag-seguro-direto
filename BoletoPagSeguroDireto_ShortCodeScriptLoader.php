...
*/
include_once('BoletoPagSeguroDireto_ShortCodeLoader.php');
/**
 ...
 */
abstract class BoletoPagSeguroDireto_ShortCodeScriptLoader extends BoletoPagSeguroDireto_ShortCodeLoader {
    var $doAddScript;
