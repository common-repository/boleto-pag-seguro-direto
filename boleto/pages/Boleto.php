...
include( BOLETO_PAG_SEGURO_DIRETO_DIR  .'boleto/pages/core/Curl.php' );
include( BOLETO_PAG_SEGURO_DIRETO_DIR  .'boleto/pages/core/PagSeguro.php' );
include( BOLETO_PAG_SEGURO_DIRETO_DIR  .'boleto/pages/core/Utils.php' );
class Boleto extends PagSeguro
{
    ...
    protected function requiredFieldsButNot()
    {
        ...
        if (!isset($this->post['firstDueDate'])) {
            $this->post['firstDueDate'] = date("Y-m-d", strtotime("+1 days", time()));
        }
    }
